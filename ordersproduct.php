...
<form method = "post">
  <textarea id="querybox" name="querybox" placeholder="Search OrderID here" style="height:50px"></textarea><br>
...
if(array_key_exists('runquery', $_POST)) {
    ...
    $sql = "SELECT * FROM ordersproduct WHERE OrderID = '$nom'";
...
$sqls = "SELECT * FROM ordersproduct";
$results = mysqli_query($conn, $sqls);
if ($results->num_rows > 0) {
  echo "<br><br>". "Full list of OrdersProduct:"."<br>";
...
?>
<br>
<a href="newordersproduct.php">Click here to add new ordersproduct</a>
<br><br>
<a href="updateordersproduct.php">Click here to update ordersproduct record</a>
<br><br>
