...
if(array_key_exists('runquery', $_POST)){
  ...
  $sql = "SELECT * FROM accountsreceivable WHERE CustomerID = '$nom'";
...
$sqls = "SELECT * FROM accountsreceivable";
$results = mysqli_query($conn, $sqls);
if ($results->num_rows > 0) {
  echo "<br><br>". "Full list of Accounts Receivable:"."<br>";
...
?>
<br>
<a href="newaccountsreceivable.php">Click here to add new accountsreceivable</a>
<br><br>
<a href="updateaccountsreceivable.php">Click here to update accountsreceivable</a>
<br><br>
